...
import DetailProductStructure from "../pages/productDetailling";
import DetailProduct from "../product/productDetail";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/detail" element={res?.messege == true ? <DetailProductStructure /> : <Navigate to="loginPanal" />}></Route>
